...
VALUES
  ('sch10000-0000-0001-0001-000000000001', 'd1000000-0000-0000-0000-000000000001', 1, '08:00', '12:00', 20, true),
  ('sch10000-0000-0001-0001-000000000002', 'd1000000-0000-0000-0000-000000000001', 1, '14:00', '18:00', 20, true),
  ('sch10000-0000-0001-0002-000000000001', 'd1000000-0000-0000-0000-000000000001', 2, '08:00', '12:00', 20, true),
  ('sch10000-0000-0001-0002-000000000002', 'd1000000-0000-0000-0000-000000000001', 2, '14:00', '18:00', 20, true),
  ('sch10000-0000-0001-0003-000000000001', 'd1000000-0000-0000-0000-000000000001', 3, '08:00', '12:00', 20, true),
  ('sch10000-0000-0001-0003-000000000002', 'd1000000-0000-0000-0000-000000000001', 3, '14:00', '18:00', 20, true),
  ('sch10000-0000-0001-0004-000000000001', 'd1000000-0000-0000-0000-000000000001', 4, '08:00', '12:00', 20, true),
  ('sch10000-0000-0001-0004-000000000002', 'd1000000-0000-0000-0000-000000000001', 4, '14:00', '18:00', 20, true),
  ('sch10000-0000-0001-0005-000000000001', 'd1000000-0000-0000-0000-000000000001', 5, '08:00', '12:00', 20, true),
  ('sch10000-0000-0001-0005-000000000002', 'd1000000-0000-0000-0000-000000000001', 5, '14:00', '18:00', 20, true)
ON CONFLICT DO NOTHING;

-- Dr. Khelifi schedules
INSERT INTO doctor_schedules (id, doctor_id, day_of_week, start_time, end_time, slot_duration, is_active)
VALUES
  ('sch10000-0000-0002-0001-000000000001', 'd1000000-0000-0000-0000-000000000002', 1, '09:00', '12:00', 20, true),
  ('sch10000-0000-0002-0001-000000000002', 'd1000000-0000-0000-0000-000000000002', 1, '14:00', '17:00', 20, true),
  ('sch10000-0000-0002-0002-000000000001', 'd1000000-0000-0000-0000-000000000002', 2, '09:00', '12:00', 20, true),
  ('sch10000-0000-0002-0003-000000000001', 'd1000000-0000-0000-0000-000000000002', 3, '09:00', '12:00', 20, true),
  ('sch10000-0000-0002-0003-000000000002', 'd1000000-0000-0000-0000-000000000002', 3, '14:00', '17:00', 20, true),
  ('sch10000-0000-0002-0004-000000000001', 'd1000000-0000-0000-0000-000000000002', 4, '09:00', '12:00', 20, true),
  ('sch10000-0000-0002-0005-000000000001', 'd1000000-0000-0000-0000-000000000002', 5, '09:00', '12:00', 20, true),
  ('sch10000-0000-0002-0005-000000000002', 'd1000000-0000-0000-0000-000000000002', 5, '14:00', '17:00', 20, true)
ON CONFLICT DO NOTHING;

-- Dr. Hammami schedules
INSERT INTO doctor_schedules (id, doctor_id, day_of_week, start_time, end_time, slot_duration, is_active)
VALUES
  ('sch10000-0000-0003-0001-000000000001', 'd1000000-0000-0000-0000-000000000003', 1, '08:00', '12:00', 20, true),
  ('sch10000-0000-0003-0002-000000000001', 'd1000000-0000-0000-0000-000000000003', 2, '08:00', '12:00', 20, true),
  ('sch10000-0000-0003-0002-000000000002', 'd1000000-0000-0000-0000-000000000003', 2, '14:00', '18:00', 20, true),
  ('sch10000-0000-0003-0003-000000000001', 'd1000000-0000-0000-0000-000000000003', 3, '08:00', '12:00', 20, true),
  ('sch10000-0000-0003-0004-000000000001', 'd1000000-0000-0000-0000-000000000003', 4, '08:00', '12:00', 20, true),
  ('sch10000-0000-0003-0004-000000000002', 'd1000000-0000-0000-0000-000000000003', 4, '14:00', '18:00', 20, true),
  ('sch10000-0000-0003-0005-000000000001', 'd1000000-0000-0000-0000-000000000003', 5, '08:00', '12:00', 20, true)
ON CONFLICT DO NOTHING;

-- Dr. Tlili schedules
INSERT INTO doctor_schedules (id, doctor_id, day_of_week, start_time, end_time, slot_duration, is_active)
VALUES
  ('sch10000-0000-0004-0001-000000000001', 'd1000000-0000-0000-0000-000000000004', 1, '08:00', '12:00', 20, true),
  ('sch10000-0000-0004-0001-000000000002', 'd1000000-0000-0000-0000-000000000004', 1, '14:00', '18:00', 20, true),
  ('sch10000-0000-0004-0002-000000000001', 'd1000000-0000-0000-0000-000000000004', 2, '08:00', '12:00', 20, true),
  ('sch10000-0000-0004-0002-000000000002', 'd1000000-0000-0000-0000-000000000004', 2, '14:00', '18:00', 20, true),
  ('sch10000-0000-0004-0003-000000000001', 'd1000000-0000-0000-0000-000000000004', 3, '08:00', '12:00', 20, true),
  ('sch10000-0000-0004-0004-000000000001', 'd1000000-0000-0000-0000-000000000004', 4, '08:00', '12:00', 20, true),
  ('sch10000-0000-0004-0004-000000000002', 'd1000000-0000-0000-0000-000000000004', 4, '14:00', '18:00', 20, true),
  ('sch10000-0000-0004-0005-000000000001', 'd1000000-0000-0000-0000-000000000004', 5, '08:00', '13:00', 20, true)
ON CONFLICT DO NOTHING;
...
VALUES
  (
    'sub10000-0000-0000-0000-000000000001',
    'd1000000-0000-0000-0000-000000000001',
    'essentiel',
    'trial',
    0,
  ...
  (
    'sub10000-0000-0000-0000-000000000002',
    'd1000000-0000-0000-0000-000000000002',
    'pro',
    'trial',
    0,
  ...
  (
    'sub10000-0000-0000-0000-000000000003',
    'd1000000-0000-0000-0000-000000000003',
    'essentiel',
    'trial',
    0,
  ...
  (
    'sub10000-0000-0000-0000-000000000004',
    'd1000000-0000-0000-0000-000000000004',
    'pro',
    'trial',
    0,
...
VALUES
  ('wlt10000-0000-0000-0000-000000000001', 'd1000000-0000-0000-0000-000000000001', 120000,  350000, 35000,  195000),
  ('wlt10000-0000-0000-0000-000000000002', 'd1000000-0000-0000-0000-000000000002', 245000,  580000, 58000,  277000),
  ('wlt10000-0000-0000-0000-000000000003', 'd1000000-0000-0000-0000-000000000003',  80000,  210000, 21000,  109000),
  ('wlt10000-0000-0000-0000-000000000004', 'd1000000-0000-0000-0000-000000000004', 310000,  720000, 72000,  338000)
ON CONFLICT DO NOTHING;
...
VALUES
  ...
  (
    'at100000-0000-0000-0000-000000000004',
    'd1000000-0000-0000-0000-000000000002',
  ...
  (
    'at100000-0000-0000-0000-000000000006',
    'd1000000-0000-0000-0000-000000000003',
  ...
  -- Dr. Tlili
  (
    'at100000-0000-0000-0000-000000000007',
    'd1000000-0000-0000-0000-000000000004',
    'Bilan cardiologique complet',
    45, 100000, '#dc2626', 'cabinet', true, true
  ),
  (
    'at100000-0000-0000-0000-000000000008',
    'd1000000-0000-0000-0000-000000000004',
