    ...
    <SafeAreaView edges={["top"]} style={s.root}>
      ...
      <ScrollView contentContainerStyle={s.content}>
        <View style={s.headerCard}>
          <Text style={s.cardTitle}>Conditions générales d'utilisation</Text>
        ...
        <Section title="7. Limitation de responsabilité">
          Doktori est un outil d'aide à la gestion et ne remplace pas le jugement médical professionnel. La société RandomWalkers ne peut être tenue responsable des décisions médicales prises par les utilisateurs, ni des interruptions de service liées à des causes indépendantes de sa volonté.
        </Section>

        <Section title="8. Modifications des conditions">
          RandomWalkers se réserve le droit de modifier les présentes conditions à tout moment. Les utilisateurs seront notifiés de toute modification substantielle via l'application. La poursuite de l'utilisation vaut acceptation des nouvelles conditions.
        </Section>
        ...
        <Section title="10. Contact">
          Pour toute question : legal@doktori.tn ou par courrier à RandomWalkers, Tunis, Tunisie.
        </Section>
