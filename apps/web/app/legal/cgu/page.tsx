  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-gray max-w-none space-y-6 text-sm leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-bold mb-3">2. Définitions</h2>
        ...
        <section>
          <h2 className="text-xl font-bold mb-3">3. Services proposés</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold mb-3">4. Nature des services</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold mb-3">5. Inscription et compte utilisateur</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold mb-3">7. Données personnelles</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold mb-3">9. Droit applicable</h2>
          <p>
        ...
        <section>
          ...
          <p>
            Pour toute question relative aux présentes CGU : <a href="mailto:contact@doktori.tn" className="text-blue-600 hover:underline">contact@doktori.tn</a>
          </p>
        </section>
      </div>
    </div>
