      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        <div className="rounded-2xl border border-border bg-white p-8 shadow-sm">
          <div className="space-y-6 text-sm leading-relaxed text-gray-700">
            ...
            <section>
              <h2 className="text-lg font-bold text-foreground mb-3">2. Directeur de la publication</h2>
              <p>Omar Harbi, en qualité de Gérant de Random Walkers SUARL.</p>
            </section>

            <section>
              <h2 className="text-lg font-bold text-foreground mb-3">3. Hébergement</h2>
              <p>
                ...
                Site web : <a href="https://www.hetzner.com" className="text-primary hover:underline" target="_blank" rel="noopener">www.hetzner.com</a>
              </p>
            </section>
            ...
            <section>
              <h2 className="text-lg font-bold text-foreground mb-3">5. Protection des données personnelles</h2>
              <p>
              ...
              <ul className="mt-3 space-y-1.5">
                ...
                <li><strong>Contact DPO :</strong> <a href="mailto:dpo@doktori.tn" className="text-primary hover:underline">dpo@doktori.tn</a></li>
              </ul>
              <p className="mt-3">
                Vous disposez d&apos;un droit d&apos;accès, de rectification et de suppression de vos données personnelles. Pour exercer ces droits, contactez-nous à <a href="mailto:dpo@doktori.tn" className="text-primary hover:underline">dpo@doktori.tn</a>.
              </p>
            </section>

            <section>
              <h2 className="text-lg font-bold text-foreground mb-3">6. Limitation de responsabilité</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-bold text-foreground mb-3">7. Droit applicable</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-bold text-foreground mb-3">8. Crédits</h2>
              <p>
