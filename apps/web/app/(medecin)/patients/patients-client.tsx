      ...
      <div className="flex flex-col sm:flex-row gap-2">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2.5 text-sm ds-card placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary transition"
          />
        </div>
        <button
          type="button"
        ...
        <button
          ...
          className="inline-flex items-center gap-2 h-10 px-3 ds-card text-sm text-foreground hover:bg-secondary transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
        ...
        <div ref={columnsMenuRef} className="relative">
          <button
            ...
            className="inline-flex items-center gap-2 h-10 px-3 ds-card text-sm text-foreground hover:bg-secondary transition-colors"
          >
