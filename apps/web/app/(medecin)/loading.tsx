/**
 * Group-level fallback shown while any (medecin)/* route is mounting.
  ...
  return (
    <div className="space-y-6" aria-busy="true" aria-label="Chargement">
      ...
      <div className="space-y-2">
        <div className="h-7 w-56 animate-pulse rounded-md bg-gray-200 dark:bg-gray-700" />
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {Array.from({ length: 4 }).map((_, i) => (
          <div
            key={i}
            className="rounded-2xl border border-border dark:border-gray-700 bg-white dark:bg-gray-900 p-5 space-y-3"
          >
      ...
      {/* Main content skeleton — list-shaped */}
      <div className="rounded-2xl border border-border dark:border-gray-700 bg-white dark:bg-gray-900">
