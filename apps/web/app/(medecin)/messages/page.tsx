        ...
        <div className="flex-1 overflow-y-auto">
          {loadingConvs ? (
            ...
            conversations.map((conv) => (
              ...
              >
                <div className="w-10 h-10 rounded-full bg-[#134E4A] flex items-center justify-center text-white text-sm font-semibold flex-shrink-0">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-500 truncate">{conv.patientPhone}</p>
                </div>
              </button>
            ))
          )}
        ...
        {!selected ? (
          ...
          <>
            ...
            <header className="bg-white border-b border-gray-100 px-5 py-3 flex items-center gap-3 flex-shrink-0">
              <div className="w-9 h-9 rounded-full bg-[#134E4A] flex items-center justify-center text-white text-sm font-semibold">
                {initials(selected.patientName)}
              </div>
              <div>
                <p className="font-semibold text-gray-900 text-sm">{selected.patientName}</p>
                <p className="text-xs text-gray-500">{selected.patientPhone}</p>
              </div>
            </header>
                      ...
                      >
                        ...
                        <p
                          className={`text-[10px] mt-1 ${
                            isDoctor ? "text-teal-200" : "text-gray-400"
                          }`}
                        >
