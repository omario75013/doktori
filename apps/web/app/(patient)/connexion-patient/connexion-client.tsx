...
export function ConnexionPatientClient() {
  ...
  // If a patient is already logged in, redirect to their space immediately.
  useEffect(() => {
    try {
      ...
      // localStorage unavailable — render the form normally
    }
  }, [router]);
