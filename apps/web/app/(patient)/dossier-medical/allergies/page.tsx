    ...
    <div className="min-h-screen bg-secondary/40">
      <div className="bg-gradient-to-br from-primary to-foreground px-4 py-8">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-black text-white">Allergies</h1>
              <p className="text-white/70 text-xs mt-0.5">{items.length} allergie{items.length !== 1 ? "s" : ""} déclarée{items.length !== 1 ? "s" : ""}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-4">
        <Button onClick={openAdd} className="w-full h-12 rounded-xl bg-primary hover:bg-doktori-teal-dark text-white font-bold">
          <Plus className="h-4 w-4 mr-2" /> Ajouter une allergie
        </Button>
